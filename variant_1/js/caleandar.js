    ...
    function AddDateTime() {
        ...
        if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
            ...
            rwd.addEventListener('click', function() {
                ...
                function addListenersPrevMonth() {
                    ...
                    for (var index = 0; index < days.length; index++) {
                        days[index].addEventListener('click', function(event) {
                            ...
                            var month = calendar.Selected.Month + 1;
                ...
                addListenersPrevMonth();
            });
            rwd.innerHTML = '<svg id ="prevArrow" height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,50 75,0 75,100"></polyline></svg>';
        ...
        if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
            ...
            fwd.innerHTML = '<svg id ="nextArrow" height="15" width="15" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,0 75,50 0,100"></polyline></svg>';
